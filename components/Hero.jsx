      ...
      <div className="maw-w-[940px] 2xl:min-h-[448px] w-full bg-[url('/images/profile-hero-cover.png')]  bg-cover bg-no-repat sm:bg-center  bg-[right] flex flex-col justify-between ">
        ...
        >
          <div className="flex items-center flex-wrap gap-2 md:gap-4">
            <button className="text-[14px] hover:scale-90 transition duration-300 ease-in-out  w-[116px] h-[40px] font-bold leading-5 text-white font-satoshi-bold rounded-[4px] bg-[linear-gradient(90deg,#D136F6_0%,#6C5DD3_100%)] backdrop-blur-[8px]  ">
              Add Friends
            </button>
          ...
          <div className="flex items-center justify-center flex-wrap gap-4">
            <button
              className="text-[14px] hover:scale-90 transition duration-300 ease-in-out  w-[141px] h-[40px] font-bold leading-5 text-white font-satoshi-bold rounded-[4px] border-[0.5px] 
            border-white/[0.24] backdrop-blur-[4px]  "
            >
              NFT collections
            </button>
            <button
              className="text-[14px] hover:scale-90 transition duration-300 ease-in-out  w-[162px] h-[40px] font-bold leading-5 text-white font-satoshi-bold rounded-[4px] border-[0.5px] 
            border-white/[0.24] backdrop-blur-[4px]  "
            >
              Crypto Collections
            </button>
